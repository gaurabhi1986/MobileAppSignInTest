package com.mobile.app.test.steps;

import static org.junit.Assert.assertTrue;

import java.util.Properties;

import com.mobile.app.test.pages.PasswordScreenPage;
import com.mobile.app.test.pages.SearchScreenPage;
import com.mobile.app.test.pages.SignInScreenPage;
import com.mobile.app.test.pages.WelcomeScreenPage;
...
public class LoginTestSteps {
	...
	public void user_navigate_to_search_screen() throws Throwable {
		...
		assertTrue("Sign in test failed",searchScreen.isSearchScreen());
	}
